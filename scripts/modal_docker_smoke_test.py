...
Pulls the published `ghcr.io/fastcrest/tether-vla:<tag>` image on a
...
image = modal.Image.from_registry("ghcr.io/fastcrest/tether-vla:0.2.0")
...
def smoke_test():
    ...
    bug — `docker run ghcr.io/fastcrest/tether-vla:0.2.0 --help` works
