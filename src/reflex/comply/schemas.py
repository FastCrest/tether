"""Shared constants and lightweight schema helpers for Reflex Comply."""
...
SCHEMA_VERSION = "reflex.comply_bundle.v1"
...
class DeploymentMetadata:
    product_name: str = "Reflex robot deployment"
    deployment_id: str = ""
    robot_id: str = ""
    manufacturer: str = ""
    operator: str = ""
