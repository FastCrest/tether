...
from tether.curate.failure_classifier.modes import (
    detect_action_clamp,
    detect_collision,
...
from tether.curate.failure_classifier.primary import primary_failure
...
def classify_episode(
    *,
    ...
    """
    from tether.curate.failure_classifier import CLASSIFIER_VERSION
