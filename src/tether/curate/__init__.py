"""Tether Curate wedge — cross-customer real-world VLA data collection.

The 8th wedge. Per the architecture ADR (`reflex_context/01_decisions/
2026-05-05-data-curate-wedge-architecture.md`):

- Free tier: opt-in via `tether contribute --opt-in`. Earns Pro credits.
