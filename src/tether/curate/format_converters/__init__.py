"""Format converters: Tether JSONL traces → published-dataset formats.
...
CLI surface:
    tether curate convert <input.jsonl> --format <name> --output ./out/
...
from tether.curate.format_converters.hdf5 import HDF5Converter
from tether.curate.format_converters.lerobot_v3 import LeRobotV3Converter
from tether.curate.format_converters.openx_embodiment import (
    EMBODIMENT_OXE_MAP,
    OpenXEmbodimentConverter,
)
from tether.curate.format_converters.rlds import RLDSConverter
