...
Output layout (single-file mode, default):
    ...
    <output>.h5
    ├── meta/                                    (group)
    │   ├── dataset_id, tether_version, created_at, num_episodes
...
class HDF5Converter(FormatConverter):
    """Convert Tether JSONL traces → HDF5 hierarchical container."""
    ...
    def __init__(
        self,
        *,
        dataset_id: str = "tether_curate_dataset",
    ...
    def _write_single_file(
        ...
        *,
        ...
        with h5py.File(file_path, "w") as h5:
            ...
            meta.attrs["tether_version"] = self._tether_version()
