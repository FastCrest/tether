...
Phase 2 deferrals (per spec):
  ...
  - tfds.dataset_builder integration (would let consumers use
    `tfds.load("tether_curate_dataset")`; we ship the directory format
...
class RLDSConverter(FormatConverter):
    """Convert Tether JSONL traces → RLDS / TFRecord format."""
    ...
    def __init__(
        self,
        *,
        dataset_name: str = "tether_curate_dataset",
    ...
    def _write_metadata(
        ...
        *,
        ...
        info = {
            ...
            "description": (
                "Tether Curate dataset in RLDS format. Generated from contributed "
