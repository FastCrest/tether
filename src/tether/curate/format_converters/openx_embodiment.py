...
RLDS / TFRecord. Adds:
  - `embodiment_id` field per episode (Tether slug → OXE canonical name,
...
# Tether embodiment slug → OXE canonical embodiment name.
...
class OpenXEmbodimentConverter(FormatConverter):
    """Convert Tether JSONL traces → Open X-Embodiment dataset directory.
    ...
    def __init__(
        ...
        *,
        ...
        self.dataset_name = f"tether_curate_{embodiment.lower()}"
