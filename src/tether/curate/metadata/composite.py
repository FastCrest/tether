...
from tether.curate.metadata.difficulty import difficulty_from_instruction
from tether.curate.metadata.language import detect_language
from tether.curate.metadata.task_classifier import (
    classify_subtype,
    classify_task,
)
from tether.curate.metadata.trajectory_tags import (
    action_complexity,
...
def enrich_metadata(
    *,
    ...
    """
    from tether.curate.metadata import TAXONOMY_VERSION
