...
The minimal example:
    ...
    >>> from tether.registry.builder import Registry, build_from_cfg
...
- No circular imports — this module imports nothing from `src/tether/models/`.
"""
...
class Registry:
    ...
    def names(self) -> list[str]:
        """Sorted list of registered names. Useful for `tether models list` UX."""
