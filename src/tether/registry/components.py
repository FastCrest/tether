...
Each registry is a `Registry` instance from `tether.registry.builder`.
...
`src/tether/models/{vision,llm,vlm,projectors,heads,text,vlas}/*.py` register
themselves via decorators at module import time.
"""
from __future__ import annotations

from tether.registry.builder import Registry
...
# here. `tether models pull <id>` resolves the ModelEntry's `vla_type` field
