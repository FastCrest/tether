...
class Pi0ExpertStackWithPrefix(nn.Module):
    ...
    def forward(
        ...
        from tether.models.heads.expert_stack import _sinusoidal_pos_embedding
...
def build_pi05_expert_with_prefix(state_dict: dict[str, torch.Tensor]) -> tuple[Pi05ExpertStackWithPrefix, dict]:
    ...
    """
    from tether.exporters.pi0 import build_pi05_expert_stack, PI05_ACTION_KEYS, PI0_EXPERT_PREFIX
