"""Typer command body for `tether finetune`.

Registered from src/tether/cli.py via `from tether.finetune.cli import
...
def finetune_command(
    ...
    skip_export: bool = typer.Option(
        False,
        "--skip-export",
        help="Train only; don't auto-run tether export. Useful for "
