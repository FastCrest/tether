"""Configs + result shapes for tether finetune.
...
class FinetuneConfig:
    ...
    Routed to backends via tether.finetune.backends.resolve_backend()."""

    teacher_export: str | None = None
    """For phase='distill' only: path/HF-id of the teacher's tether-
    ...
    See tether_vault 01_architecture/distill_state_out_pi05_design.md."""
    ...
    Values:
      ...
      - 'teacher_supervised': L2(v_student, v_teacher) at random t.
        ...
        state" fixed point.
    See tether_vault 03_experiments/2026-04-22-v0.5-retry-plan-pmcd.md."""
