...
Read by `tether serve --embodiment <name>` so the runtime knows the robot's
...
RTC adapter (B.3), action denormalization (B.6), and tether doctor (D.1).

Pattern mirrors `src/tether/config.py:HARDWARE_PROFILES` — module-level
