...
CLI surface:
    tether calibrate so100 corners      (hand-guide arm to 4 tablet corners)
    tether calibrate so100 surface      (probe surface depth + fit tap model)
    tether calibrate so100 all          (run the full sequence)
