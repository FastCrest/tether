...
# yapf: disable
# Vendored from FluxVLA's fluxvla/ops/* — paths re-pointed at tether.kernels.*
# per Lift #5 (see src/tether/kernels/ATTRIBUTION.txt for the three-source
...
from tether.kernels.triton.norm import (
