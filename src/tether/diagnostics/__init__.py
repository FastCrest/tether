"""Tether serve deployment diagnostics — `tether doctor`.
...
Canonical: features/01_serve/subfeatures/_dx_gaps/tether-doctor.md
"""
        ...
        try:
            ...
            return CheckResult(
                ...
                remediation=(
                    ...
                    f"https://github.com/FastCrest/tether-vla/issues with the "
...
def format_human(results: list[CheckResult]) -> str:
    ...
    lines: list[str] = []
    lines.append(
        f"tether doctor — {len(results)} checks, "
