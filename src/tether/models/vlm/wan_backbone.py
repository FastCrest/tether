...
The tether version rewrites imports to point at
``tether.models.third_party.dreamzero.modules`` instead of
...
def _import_wan_modules():
    from tether.models.third_party.dreamzero.modules.wan_video_text_encoder import WanTextEncoder
    from tether.models.third_party.dreamzero.modules.wan_video_image_encoder import WanImageEncoder
    from tether.models.third_party.dreamzero.modules.wan_video_vae import WanVideoVAE
